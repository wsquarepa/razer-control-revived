...
PlasmoidItem {
    ...
    // profile. Hyperboost (7) is AC-only; Razer pairs it with the cooling pad.
    function availableProfiles() {
        return root.acState === "ac" ? [0, 5, 2, 4, 7] : [6, 3]
    }
    function fanPresets() {
        ...
        case 7: return [0, 3700, 4200, 4800, 5300]
        default: return [0]
        }
    }
                ...
                ColumnLayout {
                    ...
                    MouseArea {
                        ...
                        RowLayout {
                            ...
                            Item { Layout.fillWidth: true }
                            QQC2.Label {
                                text: { switch(powerProfile) { case "0": case "6": return "Balanced"; case "2": return "Maximum Performance"; case "3": return "Battery Saver"; case "4": return "Custom"; case "5": return "Silent"; case "7": return "Hyperboost"; default: return "--"; } }
